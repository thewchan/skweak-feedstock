...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/skweak-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14945&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/skweak-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `skweak` can be installed with:

```
conda install skweak
```

It is possible to list all of the versions of `skweak` available on your platform with:
